 ...
 *
 * @param {object} meeting  - Mongoose document or plain object with .rrule, .isRecurringBase, .exceptedDates
 * @param {Date}   startDate
 * @param {Date}   endDate
 * @returns {object[]} virtual meeting objects
 */
export function expandInRange(meeting, startDate, endDate) {
 ...
 */
export function extractRrulePart(rruleStr) {
  if (!rruleStr) return '';
 ...
 *   → "DTSTART:20260421T000000Z\nRRULE:FREQ=WEEKLY;BYDAY=MO"
 */
export function buildRrule(freqOptions, dtstart) {
